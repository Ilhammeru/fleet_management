...
/* harmony import */ var notiflix__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! notiflix */ "./node_modules/notiflix/dist/notiflix-aio-3.2.6.min.js");
...
var baseUrl = "http://fleet-management.test";
...
function showNotification(payload) {
  if (payload.success) {
    notiflix__WEBPACK_IMPORTED_MODULE_1__.Notify.success(payload.message);
  } else {
    notiflix__WEBPACK_IMPORTED_MODULE_1__.Notify.failure(payload.message);
  }
}
function showLoading() {
  var message = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : i18n.global.processing;
  notiflix__WEBPACK_IMPORTED_MODULE_1__.Loading.dots(message);
}
function hideLoading() {
  notiflix__WEBPACK_IMPORTED_MODULE_1__.Loading.remove();
}
...
function showFormErrorValidation(errors, formId) {
  var formElem = $("#".concat(formId));
  for (var a in errors) {
    if (document.querySelector("#".concat(formId, " div[data-error=\"").concat(a, "\"]"))) {
      document.querySelector("#".concat(formId, " div[data-error=\"").concat(a, "\"]")).innerHTML = errors[a][0];
      document.querySelector("#".concat(formId, " div[data-error=\"").concat(a, "\"]")).style.display = 'block';
    }
    if (document.querySelector("#".concat(formId, " div[id=\"conjunction-").concat(a, "\"]"))) {
      document.querySelector("#".concat(formId, " div[id=\"conjunction-").concat(a, "\"]")).style.display = 'block';
    }
    if (document.querySelector("#".concat(formId, " select[id=\"").concat(a, "\"]"))) {
      document.querySelector("#".concat(formId, " select[id=\"").concat(a, "\"]")).classList.add('is-invalid');
    }
    if (document.querySelector("#".concat(formId, " input[id=\"").concat(a, "\"]"))) {
      document.querySelector("#".concat(formId, " input[id=\"").concat(a, "\"]")).classList.add('is-invalid');
    }
  }
}
function defaultFormValidation(formId) {
  ...
  $('#' + formId).find('select').each(function (i, elem) {
    $(elem).removeClass('is-invalid');
  });
  $('#' + formId).find('.invalid-feedback').each(function (i, elem) {
    $(elem).html('');
    $(elem).css({
      display: 'none'
    });
  });
  $('#' + formId).find('.conjunction').each(function (i, elem) {
    $(elem).css({
      display: 'none'
    });
  });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (isXHRAdapterSupported && function (config) {
  return new Promise(function dispatchXhrRequest(resolve, reject) {
    ...
    if(_platform_index_js__WEBPACK_IMPORTED_MODULE_10__["default"].hasStandardBrowserEnv) {
      ...
      if (withXSRFToken || (withXSRFToken !== false && (0,_helpers_isURLSameOrigin_js__WEBPACK_IMPORTED_MODULE_5__["default"])(fullPath))) {
        // Add xsrf header
...
/******/ 	__webpack_require__.O(undefined, ["dist/auth","dist/main"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["dist/auth","dist/main"], () => (__webpack_require__("./resources/css/main.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["dist/auth","dist/main"], () => (__webpack_require__("./resources/css/auth.scss")))
